...
**2026-09-07: the count is 40.** Unit Grid was admitted under the escape clause: a regular grid of equal, discrete cells encodes a bounded count without the length encoding of Bar or the unequal-area encoding of Treemap. It ships the full §10 set with a 10x10 canonical waffle, three variants, routing, and a verifier that checks equal cells and filled-count fidelity. Punch card remains a future Unit Grid variant rather than a second top-level type.

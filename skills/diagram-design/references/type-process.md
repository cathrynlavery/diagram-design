...
```yaml
# Labour Force Survey — end-to-end workflow (Jamaica STATIN, extended variant)
...
nodes:
  ...
  - { lane: "IT",  step: 10, title: "Upload STATIN / SDMX", sub: "Results → Published",
...
- `assets/example-process.html` — minimal light (Jamaica LFS: 11 steps, 6 divisions, data-type chips). Gallery default.

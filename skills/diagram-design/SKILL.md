...
| Continuous trends over time, change between exactly two states (slopegraph), or rank movement across several snapshots (bump) | **Line chart** | [type-line.md](references/type-line.md) |

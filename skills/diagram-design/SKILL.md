...
| Angle = category, radius = magnitude; skill wheels, competency maps, cyclical data | **Polar / Radial wheel** | [type-polar-wheel.md](references/type-polar-wheel.md) |
...
| Max sectors (polar wheel) | 8 |
| Max points (polar wheel) | 12 |

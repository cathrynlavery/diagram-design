...
40 visual types. Patterns describe behavior; references describe layout. Load details from `references/` only when selected.
...
Use one of the 40 visual types (§3) when a reader will learn more from a visual than from prose, a table, or bullets.

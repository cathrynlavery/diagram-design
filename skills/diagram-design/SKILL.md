...
| Continuous trends over time, change between exactly two states (slopegraph), or a total and its composition across periods (streamgraph) | **Line chart** | [type-line.md](references/type-line.md) |

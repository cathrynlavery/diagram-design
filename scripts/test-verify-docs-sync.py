...
"""
        ...
        # are the shapes those phrasings would overmatch without a contextual
        # guard: `2-type` and `all 3 diagrams` are ordinary prose in a
        # repository that ships 40 types, and this gate blocks a pull request,
        # so rejecting them is worse than missing a stale count. The two-digit
        # cases prove the guard is contextual rather than relying on a
        # numeral-length heuristic.
        for benign in (

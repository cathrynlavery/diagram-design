...
*New in 2.6: ten more layout grammars — sankey, fishbone, Wardley map, kanban, user journey, deployment, dependency graph, UML class, story map, and database schema.*
...
**New in 2.6 — ten layout grammars nothing else covered.** Screenshots land with the next release; open the examples directly in the meantime.
